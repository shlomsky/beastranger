<div id="comments">
	...
	<div id="commentsForm">
		...
		<input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" style="font-family:calibri;height: 20px; font-size: 13px; padding: 5px; width: 300px;" />
		            ...
		            <p>
		            	<input name="submit" type="submit" id="submit" tabindex="5" value="" style="background:url('http://localhost/beastranger/images/suggest.png');width:94px;height:25px;float:right;border:none;" />
